...
import { SITE_NAME, SITE_URL, LINE_URL } from '@/lib/constants'
      ...
      <Container size="sm">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-sm text-neutral-500 leading-[2] max-w-md mx-auto" style={{ fontFamily: '"Noto Serif JP", serif' }}>
            商品に関するご質問、お取り扱いのご相談、<br />
            その他ご不明点は下記よりお気軽にご連絡ください。<br />
            営業日2〜3日以内にご返信いたします。
          </p>
        </div>
