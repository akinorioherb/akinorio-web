...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'アキノリオ（AKINORIO）の商品は公式サイト（akinorio.com）でご購入いただけます。Shopifyの安全な決済システムを使用。代表商品「ミトコンドリアのちから」（13,200円）をはじめ、引き算スターターセット（22,000円）、金の糸クリーム（22,000円）などを取り扱っています。LINEからもご相談・ご購入いただけます。',
      },
    },
    {
      '@type': 'Question',
