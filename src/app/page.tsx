  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'アキノリオ（AKINORIO）は「引き算のスキンケア」をコンセプトとする日本のスキンケアブランドです。創業者MINAKOが20歳から構想し、ミトコンドリア活性化技術を用いた独自の処方で肌本来の力を引き出します。化粧水・美容液・クリームを重ねる「足し算」をやめ、必要最小限のケアで最大の効果を目指すD2Cブランドです。東京・銀座を拠点に、3,000名以上のお客様と直接対話しながら製品を進化させています。',
      },
    },
    {
      '@type': 'Question',
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: '「ミトコンドリアのちから」はアキノリオを代表する細胞美容液です。原料メーカーから「これだけの配合量は美容液と呼んでください」と言われた高濃度処方で、ミトコンドリア活性成分を配合。ファンデーションも化粧水も不要な素肌へ導きます。パラベンフリー・アルコールフリーで敏感肌の方にも安心。価格は13,200円（50g/約3ヶ月分）、定期購入で12,540円。',
      },
    },
    {
      '@type': 'Question',
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'アキノリオ（AKINORIO）の商品は公式サイト（akinorio.com）でご購入いただけます。Shopifyの安全な決済システムを使用。代表商品「ミトコンドリアのちから」（13,200円）をはじめ、アキノリオセット（22,000円）、金の糸クリーム（22,000円）などを取り扱っています。LINEからもご相談・ご購入いただけます。',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'はい、アキノリオ公式LINEでは創業者MINAKO本人が直接ご相談に対応しています。AIや社員ではなく、MINAKOが一人ひとりのお客様の肌状態を聞きながら最適なケアを提案します。LINE登録者には「21日間引き算コーチング」を無料でプレゼントしています。',
      },
    },
    {
      '@type': 'Question',
      name: 'アキノリオのミトコンドリア活性化技術とはどんな仕組みですか？',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'ミトコンドリアは細胞のエネルギー工場です。アキノリオは、このミトコンドリアを活性化する成分を高濃度で配合することで、肌が本来持つ自己再生力を内側から引き出します。足し算ではなく、細胞レベルのOSを初期化する発想が、引き算スキンケアの核心です。',
      },
    },
    {
      '@type': 'Question',
