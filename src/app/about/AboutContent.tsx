      ...
      <div className="relative z-10 flex flex-col w-full">
        ...
        <section className="relative w-full h-[80vh] flex flex-col items-center justify-center px-6 md:px-12 pt-24 text-center">
          ...
          >
            ...
            <h1 className="sr-only">引き算の美学 — AKINORIOブランドストーリー</h1>
        ...
        <section className="relative w-full py-24 md:py-32 border-t border-white/10 bg-black/20 backdrop-blur-sm">
          <div className="mx-auto max-w-4xl px-6 md:px-12">
            ...
            >
              ...
              <div aria-hidden="true">{renderSvgTitle("20歳の構想、何十社の壁", "80")}</div>
              <h2 className="sr-only">創業者MINAKOの物語 — 20歳の構想から何十社の壁を越えて</h2>
            </motion.div>
        ...
        <section className="relative w-full py-24 md:py-32 border-t border-white/10 bg-[#7C0114]/10">
          <div className="mx-auto max-w-4xl px-6 md:px-12">
            ...
            >
              ...
              <div aria-hidden="true">{renderSvgTitle("何をつけるかより、何をやめるか", "70")}</div>
              <h2 className="sr-only">AKINORIOのフィロソフィー — 何をつけるかより、何をやめるか</h2>
            </motion.div>
        ...
        <section className="relative w-full py-24 md:py-32 border-t border-white/10 bg-black/40 backdrop-blur-md">
          <div className="mx-auto max-w-5xl px-6 md:px-12">
            ...
            >
              ...
              <div aria-hidden="true">{renderSvgTitle("売らないで広がる", "90")}</div>
              <h2 className="sr-only">AKINORIOの広がり方 — 売らないで広がる</h2>
            </motion.div>
            ...
            <motion.div
              ...
              style={{ fontFamily: '"Noto Serif JP", serif' }}
            >
              <p>アキノリオはお陰様で全国のパートナー代理店から直接ご購入いただけるようになっています。</p>
              <p>理念は「売らないで広がる」こと。<br/>自然な口コミだけで連鎖する。過度な売り込みは完全に禁止。<br/>パートナー代理店であるオーナー自身が本当に惚れ込んだ場合のみ<br/>お取り扱いいただいております。</p>
              <p>感動を伝え、その感動が次の人に届く。それだけで広がっていく。<br/>アキノリオの広がりは感動の広がりである。</p>
            </motion.div>
        ...
        <section className="relative w-full py-32 border-t border-white/20 bg-[#3D010A]/80 backdrop-blur-sm">
          <div className="mx-auto max-w-4xl px-6 md:px-12 text-center flex flex-col items-center">
            ...
            <div className="w-full max-w-3xl mb-12">
              ...
              <h2 className="sr-only">引き算の旅は、ここから始まります</h2>
            </div>
