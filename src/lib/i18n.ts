...
const jaBase = {
  ...
  skinCareStep: {
    sectionTitle: 'アキノリオセットの奇跡',
    label: 'アキノリオセット - スキンケアステップ',
    headline: 'なぜ、この順番なのか。',
    body: '圧倒的な素肌力を引き出すための、究極の3ステップ「アキノリオセット」。それぞれが明確な役割を持ち、完璧な連携で肌環境を整え、細胞からの自己再生を促します。',
    steps: [
      {
        name: 'ハーブのちから',
        title: '土台を整え、潤いの道を拓く。',
...
const jaProductDetail = {
  ...
  plans: {
    ...
    normal: { label: '通常購入', badge: '', desc: '1回のみのご購入。', subprice: '送料：600円（税込）' },
  },
  includingTax: '税込',
...
const enProductDetail = {
  ...
  plans: {
    ...
    normal: { label: 'One-time Purchase', badge: '', desc: 'Single order.', subprice: 'Shipping: ¥600' },
  },
  includingTax: 'incl. tax',
